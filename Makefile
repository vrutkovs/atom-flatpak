...
update:
	flatpak update --user io.atom.Atom
...
install-repo:
	flatpak --user remote-add --if-not-exists --no-gpg-verify nightly-atom ./repo
	flatpak --user -v install nightly-atom io.atom.Atom || true
